                ...
                <div class="grid grid-cols-4 gap-2">
                    <div class="col-span-3">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="message" rows="4" name="short_description"
                                ...
                                placeholder="Viết mô tả ngắn...">{{ old('short_description') }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="editor" rows="20" name="content"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Hãy viết bài tại đây...">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="px-2">
                        <div class="mb-6">
                            ...
                            <div class="mb-2">
                                <img id="thumbnail_preview" alt="Current Thumbnail"
                            ...
                            <input name="thumbnail"
                                ...
                                value="{{ old('thumbnail') }}" aria-describedby="file_input_help" id="file_input"
                                type="file">
                            @error('thumbnail')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                            ...
                            <select id="countries" name="articleCategories"
                                ...
                                @foreach ($articleCategoires as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('articleCategories') == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                                ...
                                @foreach ($products as $item)
                                    <li class="p-3 border rounded-lg bg-gray-100 flex items-center">
                                        <input type="radio" class="product-checkbox" id="{{ $item->id }}"
                                            ...
                                            {{ old('selected_product') == $item->id ? 'checked' : '' }}
