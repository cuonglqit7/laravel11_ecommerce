    ...
    <div class="max-w-7xl mx-auto bg-white p-3 rounded-lg shadow-md text-sm">
        <div class="flex items-center mb-3 justify-between">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Danh sách quyền
                                hạng</span>
                        </div>
                    </li>
                </ol>
            ...
            <a href="{{ route('roles.create') }}"
                class="bg-blue-500 text-white px-3 py-2 rounded hover:bg-blue-600 text-xs">Thêm sản quyền mới</a>
        </div>
        @session('success')
                    ...
                    <tr class="border-t">
                        ...
                        <td class="p-2">
                            <a href="{{ route('roles.show', $role->id) }}"
                                class="font-medium dark:text-blue-500 hover:underline">{{ $role->name }}</a>
                        </td>
                        <td class="flex gap-1">
                            <a href="{{ route('roles.edit', $role->id) }}"><svg
